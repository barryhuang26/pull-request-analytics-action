...
| `EXCLUDE_DIFF_LINE_PATTERNS`| Regular expressions for diff lines that should be ignored when calculating additions and deletions. Values should be separated by commas. Use `/pattern/flags` if flags are needed. Example: `/^\\s*$/` to ignore blank lines.                                                                                                                                                                         | -                                                                       |
